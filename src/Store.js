...
const API = 'https://betabackend-17nq.onrender.com/api/orders/checkCart'; //'http://localhost:5000/api/orders/checkCart' 'https://betabackend-17nq.onrender.com/api/orders/checkCart'
